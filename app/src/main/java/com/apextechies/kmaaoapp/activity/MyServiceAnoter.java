...
/**
 * Created by Shankar on 2/13/2018.
 */
...
public class MyServiceAnoter  extends AppCompatActivity {
    ...
    static class UIUpdateHandler extends Handler {
        ...
        private final WeakReference<MyServiceAnoter> activity;

        UIUpdateHandler(MyServiceAnoter activity) {
    ...
    public static class TimerService extends Service {
        ...
        private Notification createNotification() {
            ...
            Intent resultIntent = new Intent(this, MyServiceAnoter.class);
